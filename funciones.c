...
Paquete srlz_datosEntradas(char proceso, int codigoOperacion, int cantEntrada, int tamanioEntrada){#include "funciones.h"
...
//	nuevaInstruccion = malloc(sizeof(Instruccion)); //prueba con instruccion FUNCIONA alfinal usamos con entrada
...
//--
	...
	//int numeroDeEntrada = buscarPosicionEnBin(almacenamiento, nuevaEntrada); SE SUPONE QUE BUSCARIA LA POSICION DE LA ENTRADA EN EL BINARIO
